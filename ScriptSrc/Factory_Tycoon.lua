...
Tabs.main1:Toggle({
    ...
    Desc = "It will only work when the gear goes into the converter",
    Icon = "moon",
    Type = "Toggle",
    Default = false,
...
-- Dropdown to select and buy items
local MoonItemDropdown = Tab:Dropdown({
    Title = "Buy Moon Item",
    Values = items,
    Multi = false,
    AllowNone = false,
...
-- Button to get 10k Moon Coins
local GetMoonCoinsButton = Tab:Button({
    Title = "Get 10k Moon Coins",
    Desc = "Fires GiveMoonCoin 10,000 times",
    Locked = false,
    Callback = function()
        for i = 1, 10000 do
